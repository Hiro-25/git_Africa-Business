...
ActiveRecord::Schema.define(version: 2020_12_26_022314) do

  create_table "agricultures", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.string "name"
    t.text "text"
    t.text "image"
